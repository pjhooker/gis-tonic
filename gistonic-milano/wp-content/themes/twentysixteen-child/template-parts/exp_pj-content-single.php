...
<script>
	console.log("file: exp_pj-content-single.php caricato");
</script>
...
?>
	...
	<script>
		...
		var mymap = L.map('mapid').setView([<?php echo $pippo; ?>, <?php echo $lng; ?>], 13);
		...
		var marker = L.marker([<?php echo $lat; ?>, <?php echo $lng; ?>]).addTo(mymap);
