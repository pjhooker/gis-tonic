...
<div class=row>
	<div class=col-sm-12 style="margin-bottom:15px;">
	    ...
	    <form class="form-horizontal" action="http://gistonic-milano.1hi.it/send-photo-slot/send-photo-slot-upload/" method="POST" enctype="multipart/form-data">
	      <fieldset>
	        <legend>Seleziona la foto dal tuo computer/smartphone</legend>
	        <!--<div class="form-group is-empty">
	          <label for="inputEmail" class="col-md-2 control-label">Email</label>
	            ...
	            <div class="col-md-10">
	              <input type="text" id="textfile" readonly="" class="form-control" placeholder="Clicca qui e scegli l'immagine">
